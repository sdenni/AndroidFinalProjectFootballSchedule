 ...
 */
class TeamsAdapter(private val teams: List<KlubSepakBola>, private val listener: (KlubSepakBola) -> Unit)
...
class TeamViewHolder(view: View) : RecyclerView.ViewHolder(view){
    ...
    fun bindItem(teams: KlubSepakBola, listener: (KlubSepakBola) -> Unit) {
